...
const KitchenCounter = ({ position, rotation = [0, 0, 0], scale = 1 }) => (
  <group position={position} rotation={rotation} scale={scale}>
    {/* Base cabinets */}
    <BoxPart position={[0, 0.42, 0]}     args={[2.4, 0.84, 0.6]} material={mat.oak} />
    {/* Granite countertop */}
    <BoxPart position={[0, 0.86, 0]}     args={[2.5, 0.04, 0.65]} material={mat.granite} />
    {/* Cabinet doors */}
    {[-0.9, -0.3, 0.3, 0.9].map(x => (
      <group key={x}>
        <BoxPart position={[x, 0.42, 0.31]} args={[0.55, 0.76, 0.02]} material={mat.lightWood} />
        <CylPart position={[x + 0.2, 0.55, 0.33]} args={[0.008, 0.008, 0.06, 6]} material={mat.chrome} />
      </group>
    ))}
    {/* Backsplash */}
    <BoxPart position={[0, 1.15, -0.3]}  args={[2.5, 0.55, 0.04]} material={mat.tile} />
    {/* Sink basin */}
    <BoxPart position={[0.5, 0.82, 0.05]} args={[0.5, 0.1, 0.4]} material={mat.brushedSteel} />
    {/* Faucet base */}
    <CylPart position={[0.5, 0.96, -0.12]} args={[0.02, 0.02, 0.18, 8]} material={mat.chrome} />
    {/* Faucet arm */}
    <BoxPart position={[0.5, 1.04, -0.04]} args={[0.02, 0.02, 0.2]} material={mat.chrome} />
    {/* Faucet spout */}
    <CylPart position={[0.5, 1.0, 0.06]} args={[0.012, 0.015, 0.06, 6]} material={mat.chrome} />
    {/* Upper cabinets */}
    <BoxPart position={[-0.6, 1.65, -0.15]} args={[1.1, 0.6, 0.35]} material={mat.oak} />
    <BoxPart position={[0.65, 1.65, -0.15]} args={[0.5, 0.6, 0.35]} material={mat.oak} />
    {/* Upper cabinet doors */}
    <BoxPart position={[-0.9, 1.65, 0.01]} args={[0.5, 0.55, 0.02]} material={mat.lightWood} />
    <BoxPart position={[-0.35, 1.65, 0.01]} args={[0.4, 0.55, 0.02]} material={mat.lightWood} />
    <BoxPart position={[0.65, 1.65, 0.01]}  args={[0.45, 0.55, 0.02]} material={mat.lightWood} />
  </group>
);
...
const Refrigerator = ({ position, rotation = [0, 0, 0], scale = 1 }) => (
  <group position={position} rotation={rotation} scale={scale}>
    {/* Main body */}
    <BoxPart position={[0, 0.95, 0]}    args={[0.75, 1.9, 0.7]} material={mat.brushedSteel} />
    {/* Freezer door line */}
    <BoxPart position={[0, 1.55, 0.36]} args={[0.72, 0.01, 0.005]} material={mat.blackMetal} />
    {/* Upper door panel */}
    <BoxPart position={[0, 1.6, 0.355]} args={[0.73, 0.6, 0.01]} material={mat.brushedSteel} />
    {/* Lower door panel */}
    <BoxPart position={[0, 0.72, 0.355]} args={[0.73, 1.14, 0.01]} material={mat.brushedSteel} />
    {/* Handles */}
    <BoxPart position={[0.32, 1.6, 0.39]} args={[0.025, 0.35, 0.03]} material={mat.chrome} />
    <BoxPart position={[0.32, 0.72, 0.39]} args={[0.025, 0.6, 0.03]} material={mat.chrome} />
    {/* Ice/water dispenser */}
    <BoxPart position={[0, 1.1, 0.37]}  args={[0.2, 0.15, 0.02]} material={mat.blackMetal} />
    {/* Top vent */}
    <BoxPart position={[0, 1.92, 0]}    args={[0.74, 0.02, 0.69]} material={mat.blackMetal} />
  </group>
);
...
const DiningTable = ({ position, rotation = [0, 0, 0], scale = 1 }) => (
  <group position={position} rotation={rotation} scale={scale}>
    {/* Table top */}
    <BoxPart position={[0, 0.42, 0]}    args={[1.4, 0.05, 0.85]} material={mat.oak} />
    {/* Edge profile */}
    <BoxPart position={[0, 0.395, 0]}   args={[1.42, 0.02, 0.87]} material={mat.walnut} />
    {/* Legs (tapered via cylinder) */}
    {[[-0.58, 0.2, 0.32], [0.58, 0.2, 0.32], [-0.58, 0.2, -0.32], [0.58, 0.2, -0.32]].map((p, i) =>
      <CylPart key={i} position={p} args={[0.032, 0.025, 0.4, 6]} material={mat.walnut} />
    )}
    {/* Cross support bars */}
    <BoxPart position={[0, 0.1, 0.32]}  args={[1.0, 0.03, 0.03]} material={mat.walnut} />
    <BoxPart position={[0, 0.1, -0.32]} args={[1.0, 0.03, 0.03]} material={mat.walnut} />
  </group>
);
...
const DiningChair = ({ position, rotation = [0, 0, 0], scale = 1 }) => (
  <group position={position} rotation={rotation} scale={scale}>
    {/* Legs */}
    {[[-0.17, 0.12, 0.17], [0.17, 0.12, 0.17], [-0.17, 0.12, -0.17], [0.17, 0.12, -0.17]].map((p, i) =>
      <CylPart key={i} position={p} args={[0.018, 0.014, 0.24, 6]} material={mat.walnut} />
    )}
    {/* Seat */}
    ...
    {/* Backrest frame */}
    <BoxPart position={[0, 0.55, -0.19]} args={[0.4, 0.5, 0.04]} material={mat.walnut} />
    {/* Backrest slats */}
    {[-0.1, 0.1].map(x => (
      <BoxPart key={x} position={[x, 0.5, -0.18]} args={[0.04, 0.35, 0.02]} material={mat.oak} />
    ))}
  </group>
);
...
const Stove = ({ position, rotation = [0, 0, 0], scale = 1 }) => (
  <group position={position} rotation={rotation} scale={scale}>
    {/* Body */}
    <BoxPart position={[0, 0.44, 0]}    args={[0.6, 0.88, 0.6]} material={mat.brushedSteel} />
    {/* Stove top */}
    <BoxPart position={[0, 0.89, 0]}    args={[0.62, 0.02, 0.62]} material={mat.blackMetal} />
    {/* Burners */}
    {[[-0.15, 0.91, -0.15], [0.15, 0.91, -0.15], [-0.15, 0.91, 0.15], [0.15, 0.91, 0.15]].map((p, i) =>
      <CylPart key={i} position={p} args={[0.08, 0.08, 0.01, 12]} material={mat.blackMetal} />
    )}
    {/* Burner grates */}
    {[[-0.15, 0.92, -0.15], [0.15, 0.92, -0.15], [-0.15, 0.92, 0.15], [0.15, 0.92, 0.15]].map((p, i) =>
      <mesh key={`g-${i}`} position={p} castShadow>
        <torusGeometry args={[0.06, 0.005, 6, 12]} />
        <M {...mat.blackMetal} />
      </mesh>
    )}
    {/* Oven door */}
    <BoxPart position={[0, 0.35, 0.31]} args={[0.56, 0.55, 0.02]} material={mat.blackMetal} />
    {/* Oven handle */}
    <BoxPart position={[0, 0.64, 0.34]} args={[0.35, 0.02, 0.02]} material={mat.chrome} />
    {/* Oven window */}
    <mesh position={[0, 0.35, 0.32]}>
      <boxGeometry args={[0.42, 0.3, 0.005]} />
      <M color="#1A1A2E" roughness={0.1} metalness={0.2} transparent opacity={0.7} />
    </mesh>
    {/* Knobs */}
    {[-0.22, -0.08, 0.08, 0.22].map(x => (
      <CylPart key={x} position={[x, 0.88, 0.31]} args={[0.018, 0.018, 0.02, 8]} rotation={[Math.PI/2, 0, 0]} material={mat.chrome} />
    ))}
  </group>
);
...
const Pathway = ({ position, rotation = [0, 0, 0], scale = 1 }) => (
  <group position={position} rotation={rotation} scale={scale}>
    {/* Stepping stones */}
    {[[-0.3, 0], [0, -0.3], [0.3, 0], [0.6, -0.3], [0.9, 0]].map(([x, z], i) => (
      <mesh key={i} position={[x, 0.008, z]} receiveShadow>
        <cylinderGeometry args={[0.12, 0.12, 0.015, 8]} />
        <M color="#A0A0A0" roughness={0.6} metalness={0.1} />
      </mesh>
    ))}
  </group>
);
  ...
  switch (type) {
    ...
    case 'drawing':
      accessories.push(
        ...
        { component: Sofa,      position: [0, 0, h * 0.22],       rotation: [0, 0, 0], scale },
        { component: CoffeeTable, position: [0, 0, -h * 0.06],    rotation: [0, 0, 0], scale },
        ...
        { component: ArmChair,  position: [w * 0.3, 0, -h * 0.05], rotation: [0, -Math.PI / 4, 0], scale },
    ...
    case 'garden':
      accessories.push(
        { component: GardenTree,  position: [-w * 0.25, 0, -h * 0.25], rotation: [0, 0.3, 0], scale: scale * 1.2 },
        { component: GardenTree,  position: [w * 0.25, 0, h * 0.2],    rotation: [0, -0.5, 0], scale: scale * 0.9 },
        { component: PlantPot,    position: [-w * 0.1, 0, h * 0.3],    rotation: [0, 0, 0], scale, props: { variant: 0 } },
        { component: PlantPot,    position: [w * 0.1, 0, -h * 0.3],    rotation: [0, 0.5, 0], scale, props: { variant: 1 } },
        { component: PlantPot,    position: [w * 0.32, 0, -h * 0.25],  rotation: [0, 0, 0], scale: scale * 0.8, props: { variant: 3 } },
        { component: GardenBench, position: [0, 0, h * 0.1],           rotation: [0, Math.PI / 6, 0], scale },
        { component: Pathway,     position: [-w * 0.15, 0, 0],         rotation: [0, Math.PI / 3, 0], scale },
        { component: Fountain,    position: [0, 0, -h * 0.1],          rotation: [0, 0, 0], scale: scale * 0.8 },
      );
      break;
